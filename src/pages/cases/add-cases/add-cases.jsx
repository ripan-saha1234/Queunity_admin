...
function AddCases() {
  ...
  const progress = useMemo(() => {
    const base = 10;
    const end = 100;
    const step = stepsCount <= 1 ? 0 : stepIndex;
    const delta = stepsCount <= 1 ? 0 : (end - base) / (stepsCount - 1);
    return Math.round(base + step * delta);
        ...
        >
          <div className="add-cases-grid-2">
            <CommonSelect
              ...
              onChange={(e) =>
                setFormData((prev) => ({ ...prev, offenceCategory: e.target.value }))
              }
              required
        ...
        >
          <div className="add-cases-question-options">
            <ChoiceRadio
              ...
              onChange={(value) =>
                setFormData((prev) => ({ ...prev, anonymityLevel: value }))
              }
            />
            <ChoiceRadio
              name="anonymityLevel"
              ...
              checked={formData.anonymityLevel === "student_subject_only"}
              onChange={(value) =>
                setFormData((prev) => ({ ...prev, anonymityLevel: value }))
              }
            />
          ...
          <div className="add-cases-privacy-options">
            <label className="add-cases-privacy-radio">
              <input
                ...
                onChange={() =>
                  setFormData((prev) => ({ ...prev, privacyLevel: "level_1" }))
                }
              />
              <span className="add-cases-choice-control add-cases-choice-control-radio" aria-hidden="true" />
              <div className="add-cases-privacy-text">
                <div className="add-cases-privacy-title">Level 1 (Default)</div>
                <div className="add-cases-privacy-note">Note: Only principal</div>
              </div>
            </label>
            ...
            <label className="add-cases-privacy-radio">
              <input
                ...
                onChange={() =>
                  setFormData((prev) => ({ ...prev, privacyLevel: "level_2" }))
                }
              />
              <span className="add-cases-choice-control add-cases-choice-control-radio" aria-hidden="true" />
              <div className="add-cases-privacy-text">
