...
import "./view-cases-school.css";

function ViewCasesSchool() {
  ...
  usePageHeader({
    ...
    breadcrumbs: [
      ...
      { title: "View Cases", link: `/schools/details/${id || "1"}/view-cases` },
    ],
  ...
  return (
    <div className="view-cases-school-page">
      <CommonTable
...
export default ViewCasesSchool;
